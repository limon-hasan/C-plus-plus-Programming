...
int main() {
	...
	// cout << m1.age << endl;   // This will show error becuase private member of the super class cannot be accessed directly outside the child class and the parent class itself
	Human h1;
