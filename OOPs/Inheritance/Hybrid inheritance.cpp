...
public:
	Employee(string name, int empId) : Person(name), employeeId(empId) {
	}
...
public:
	Student(string name, int stuId) : Person(name), studentId(stuId) {
	}
...
public:
	StudentIntern(string name, int stuId, int empId) : Student(name, stuId), Employee(name, empId) {
	}
